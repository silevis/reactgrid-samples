...
import { GridContext, Direction, Range, Location, Row, Column } from "../Common";
...
export class FillHandleBehavior {
    ...
    handlePointerMove(event: PointerEvent) {
        ...
        diffrences.push({ direction: 'down', value: 0 });
        diffrences.push({
            direction: 'up',
            value:
    ...
    renderPanePart(pane: Range): React.ReactNode {
        ...
        console.log(this.fillDirection)
        return (
            <>
                {focusedLocation && pane.contains(focusedLocation) && <CellFocus location={focusedLocation} />}
                {this.fillDirection && <h1>hello</h1> }
            </>
