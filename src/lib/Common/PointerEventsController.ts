...
export class PointerEventsController {
    ...
    public handlePointerDown = (event: PointerEvent) => {
        ...
        if (event.pointerType === 'mouse' || isSameLocation(previousLocation, currentLocation) || event.pointerType === undefined) { // === undefined only for cypress tests
    ...
    private handlePointerUp = (event: PointerEvent) => {
        ...
        if (event.pointerType !== 'mouse' && isSameLocation(this.pointerDownLocation, currentLocation) && event.pointerType !== undefined) { // !== undefined only for cypress tests
