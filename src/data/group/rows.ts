...
export const rows = (reorderable: boolean): any[] => [
 {
  ...
  },
  {
    ...
    reorderable,
    cells: [
      { type: 'group', text: '1', isExpanded: true, hasChildrens: true} as GroupCell,
  ...
  },
  {
    ...
    reorderable,
    cells: [
      { type: 'group', text: '2', depth: 0, isExpanded: true, parentId: 1 } as GroupCell,
      { type: 'text', text: 'fix/some-feature' } as TextCell,
  ...
  },
  {
    ...
    reorderable,
    cells: [
      { type: 'group', text: '3', depth: 0, isExpanded: true, hasChildrens: true } as GroupCell,
  ...
  },
  {
    ...
    reorderable,
    cells: [
      { type: 'group', text: '4', depth: 0, isExpanded: true, parentId: 3, hasChildrens: true } as GroupCell,
      { type: 'text', text: 'fix/my-sample' } as TextCell,
  ...
  },
  {
    ...
    reorderable,
    cells: [
      { type: 'group', text: '5', depth: 0, isExpanded: true, parentId: 4 } as GroupCell,
      { type: 'text', text: 'fix/my-sample' } as TextCell,
  ...
  },
  {
    ...
    reorderable,
    cells: [
      { type: 'group', text: '6', depth: 0, isExpanded: true, parentId: 4 } as GroupCell,
      { type: 'text', text: 'fix/my-sample' } as TextCell,
  ...
  },
  {
    ...
    reorderable,
    cells: [
      { type: 'group', text: '7', depth: 0, isExpanded: true, hasChildrens: true } as GroupCell,
  ...
  },
  {
    ...
    reorderable,
    cells: [
      { type: 'group', text: '8', depth: 0, isExpanded: true, parentId: 7 } as GroupCell,
      { type: 'text', text: 'fix/other-feature' } as TextCell,
  ...
  },
  {
    ...
    reorderable,
    cells: [
      { type: 'group', text: '9', depth: 0, isExpanded: true, parentId: 7 } as GroupCell,
      { type: 'text', text: 'fix/other-feature' } as TextCell,
  ...
  },
  {
    ...
    reorderable,
    cells: [
      { type: 'group', text: '10', depth: 0, isExpanded: true, parentId: 7 } as GroupCell,
      { type: 'text', text: 'fix/other-feature' } as TextCell,
  ...
  },
  {
    ...
    reorderable,
    cells: [
      { type: 'group', text: '11', depth: 0, isExpanded: true, hasChildrens: true } as GroupCell,
  ...
  },
  {
    ...
    reorderable,
    cells: [
      { type: 'group', text: '12', depth: 0, isExpanded: true, parentId: 11, hasChildrens: true } as GroupCell,
      { type: 'text', text: 'update/some-feature' } as TextCell,
  ...
  },
  {
    ...
    reorderable,
    cells: [
      { type: 'group', text: '13', depth: 0, isExpanded: true, parentId: 11, hasChildrens: true } as GroupCell,
      { type: 'text', text: 'update/some-feature' } as TextCell,
  ...
  },
  {
    ...
    reorderable,
    cells: [
      { type: 'group', text: '14', depth: 0, isExpanded: true, parentId: 13} as GroupCell,
      { type: 'text', text: 'update/some-feature' } as TextCell,
  ...
  },
  {
    ...
    reorderable,
    cells: [
      { type: 'group', text: '15', depth: 0, isExpanded: true, parentId: 13 } as GroupCell,
      { type: 'text', text: 'update/some-feature' } as TextCell,
