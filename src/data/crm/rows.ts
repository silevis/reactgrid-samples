...
export const rows = (reorderable: boolean): any[] => [
  ...
  },
  {
    ...
    cells: [
      ...
      // { type: 'number', text: 7958372938 },
      // { type: 'text', text: 'New York' },
      // { type: 'text', text: 'Wellham Ave' },
      // { type: 'date', text: '2009-09-04' },
      { type: 'flag', text: 'usa' },
      // { type: 'date', text: '1962-09-04' },
      // { type: 'text', text: 'Director' },
      // { type: 'dropdownNumber', text: { value: 20, isOpened: false } },
      // { type: 'checkbox', text: true }
    ]
  },
  // {
  //   rowId: '2',
  ...
  //     { type: 'number', text: 7953748271 },
  //     { type: 'text', text: 'Ji\'an' },
  //     { type: 'text', text: 'Jizhou Qu' },
  //     { type: 'date', text: '2012-01-12' },
  //     { type: 'flag', text: 'chn' },
  //     { type: 'date', text: '1985-11-06' },
  //     { type: 'text', text: 'CEO' },
  //     { type: 'dropdownNumber', text: { value: 50, isOpened: false } },
  //     { type: 'checkbox', text: false }
  //   ]
  // },
  // {
  //   rowId: '3',
  ...
  //     { type: 'number', text: 574859602 },
  //     { type: 'text', text: 'Ust-Ilimsk' },
  //     { type: 'text', text: 'Myasorubka' },
  //     { type: 'date', text: '2016-11-23' },
  //     { type: 'flag', text: 'rus' },
  //     { type: 'date', text: '1985-12-28' },
  //     { type: 'text', text: 'QA' },
  //     { type: 'dropdownNumber', text: { value: 100, isOpened: false } },
  //     { type: 'checkbox', text: false }
  //   ]
  // },
  // {
  ...
  //     { type: 'date', text: '2011-12-03' },
  //     { type: 'flag', text: 'usa' },
  //     { type: 'date', text: '1973-07-11' },
  //     { type: 'text', text: 'IT Support' },
  //     { type: 'dropdownNumber', text: { value: 90, isOpened: false } },
  //     { type: 'checkbox', text: false }
  //   ]
  // },
  // {
  ...
  //     { type: 'number', text: 697038495 },
  //     { type: 'text', text: 'Houston' },
  //     { type: 'text', text: 'Marina St' },
  //     { type: 'date', text: '2017-07-13' },
  //     { type: 'flag', text: 'usa' },
  //     { type: 'date', text: '1943-09-25' },
  //     { type: 'text', text: 'CFO' },
  //     { type: 'dropdownNumber', text: { value: 100, isOpened: false } },
  //     { type: 'checkbox', text: false }
  //   ]
  ...
  //     { type: 'number', text: 584729732 },
  //     { type: 'text', text: 'Choix' },
  //     { type: 'text', text: 'SIN 24' },
  //     { type: 'date', text: '2017-07-13' },
  //     { type: 'flag', text: 'mex' },
  //     { type: 'date', text: '1960-09-15' },
  //     { type: 'text', text: 'Marketing manager' },
  //     { type: 'dropdownNumber', text: { value: 88, isOpened: false } },
  //     { type: 'checkbox', text: false }
  //   ]
  // },
  // {
  ...
  //     { type: 'number', text: 5748373274 },
  //     { type: 'text', text: 'Guatemala' },
  //     { type: 'text', text: 'Calle Oriente' },
  //     { type: 'date', text: '2013-11-03' },
  //     { type: 'flag', text: 'gtm' },
  //     { type: 'date', text: '1954-12-01' },
  //     { type: 'text', text: 'CFO' },
  //     { type: 'dropdownNumber', text: { value: 100, isOpened: false } },
  //     { type: 'checkbox', text: true }
  //   ]
  ...
  //     { type: 'number', text: 5478439347 },
  //     { type: 'text', text: 'Havana' },
  //     { type: 'text', text: 'Via Blanca' },
  //     { type: 'date', text: '2014-03-20' },
  //     { type: 'flag', text: 'cub' },
  //     { type: 'date', text: '1979-07-12' },
  ...
  //     { type: 'number', text: 958437283 },
  //     { type: 'text', text: 'Buenos Aires' },
  //     { type: 'text', text: 'Dr. Ricardo Gutiérrez' },
  //     { type: 'date', text: '2015-08-39' },
  //     { type: 'flag', text: 'arg' },
  //     { type: 'date', text: '1964-02-07' },
  //     { type: 'text', text: 'Operations manager' },
  //     { type: 'dropdownNumber', text: { value: 77, isOpened: false } },
  //     { type: 'checkbox', text: false }
  //   ]
  // },
  // {
  ...
  //     { type: 'number', text: 654890374 },
  //     { type: 'text', text: 'Adelaide' },
  //     { type: 'text', text: 'Essex' },
  //     { type: 'date', text: '2017-12-02' },
  //     { type: 'flag', text: 'aus' },
  //     { type: 'date', text: '1944-01-04 ' },
  //     { type: 'text', text: 'Accountant' },
  //     { type: 'dropdownNumber', text: { value: 35, isOpened: false } },
  //     { type: 'checkbox', text: true }
  //   ]
  // },
  // {
  ...
  //     { type: 'number', text: 2398584578 },
  //     { type: 'text', text: 'London' },
  //     { type: 'text', text: 'Agar St' },
  //     { type: 'date', text: '2015-04-13' },
  //     { type: 'flag', text: 'gbr' },
  //     { type: 'date', text: '1970-04-18' },
  //     { type: 'text', text: 'Actor' },
  //     { type: 'dropdownNumber', text: { value: 70, isOpened: false } },
  //     { type: 'checkbox', text: false }
  //   ]
  // },
  // {
  ...
  //     { type: 'number', text: 5473895647 },
  //     { type: 'text', text: 'Paris' },
  //     { type: 'text', text: 'Elisses' },
  //     { type: 'date', text: '2011-11-11' },
  //     { type: 'flag', text: 'FRA' },
  //     { type: 'date', text: '1950-04-15' },
  //     { type: 'text', text: 'CPA' },
  //     { type: 'dropdownNumber', text: { value: 20, isOpened: false } },
  //     { type: 'checkbox', text: false }
  //   ]
  ...
  //     { type: 'number', text: 2309548374 },
  //     { type: 'text', text: 'Montrreal' },
  //     { type: 'text', text: 'Boulevard Alexis-Nihon' },
  //     { type: 'date', text: '2018-06-19' },
  //     { type: 'flag', text: 'can' },
  //     { type: 'date', text: '1950-01-24 ' },
  //     { type: 'text', text: '--' },
  //     { type: 'dropdownNumber', text: { value: 10, isOpened: false } },
  //     { type: 'checkbox', text: true }
  //   ]
  // },
  // {
  ...
  //     { type: 'number', text: 5438904375 },
  //     { type: 'text', text: 'Cair' },
  //     { type: 'text', text: 'Abd El-Khalik Tharwat' },
  //     { type: 'date', text: '2018-06-19' },
  //     { type: 'flag', text: 'egy' },
  //     { type: 'date', text: '1925-08-27 ' },
  //     { type: 'text', text: '--' },
  //     { type: 'dropdownNumber', text: { value: 20, isOpened: false } },
  //     { type: 'checkbox', text: false }
  //   ]
  ...
  //     { type: 'number', text: 99657346 },
  //     { type: 'text', text: 'Malmo' },
  //     { type: 'text', text: 'Södra Rosengård' },
  //     { type: 'date', text: '2018-06-19' },
  //     { type: 'flag', text: 'swe' },
  //     { type: 'date', text: '1968-04-02' },
  //     { type: 'text', text: 'President' },
  //     { type: 'dropdownNumber', text: { value: 40, isOpened: false } },
  //     { type: 'checkbox', text: true }
  //   ]
  // },
]