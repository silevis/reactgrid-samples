...
export var WorkhoursSample = function () {
    ...
    var _b = __read(useState({ h: 0, s: 1, l: 0.5 }), 2), color = _b[0], setColor = _b[1];
    ...
    return (React.createElement("div", { className: "workhours-sample" },
        ...
        React.createElement("div", { className: "configurator" },
